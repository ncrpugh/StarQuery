...
- **Goal:** Identify and repair spaceship system faults using SQL
- **Platform:** Web browser
- **Core technologies:** JavaScript, HTML, CSS, SQL, SQL.js/WebAssembly
- **Database:** In-browser SQLite database
